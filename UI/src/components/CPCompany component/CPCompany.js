import './CPCompany.css';
import {useState } from "react";
import {companyapiurl} from '../UserAPIURL component/userapiurl.js';
...
function CPCompany(){
    ...
    const handleSubmit=()=>{
        axios.get(companyapiurl+"fetch?email="+localStorage.getItem("email")+"&password="+oldPassword).then((response)=>{
